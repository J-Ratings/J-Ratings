...
RUN_END_DATE   <- as.Date("2025-12-31")
...
dir.create(elo_dir, recursive = TRUE, showWarnings = FALSE)

input_file <- file.path(
  source_dir,
  "go_games_from_sgf.csv"
)
...
history_file_pass1 <- file.path(
  elo_dir,
  "game_history_pass1.csv"
)

final_file_pass1 <- file.path(
  elo_dir,
  "final_ratings_pass1.csv"
)
